...
save_plot("apresentacao/images/anova_plot.png", anova_plot, base_height = 5, base_aspect_ratio = 1.3)
...
centered_anova_plot = ggplot(pop_df, aes(genótipos, Fenótipo)) + geom_jitter(size = 2, width = 0.2) + geom_hline(yintercept = 3) +
  ...
  geom_point(data = medias, size = 5, color = "red")
save_plot("apresentacao/images/centered_anova_plot.png", centered_anova_plot, base_height = 5, base_aspect_ratio = 1.3)
...
save_plot("apresentacao/images/ortogonal_regression_plot.png", ortogonal_regression, base_height = 5, base_aspect_ratio = 1.3, ncol = 2)
